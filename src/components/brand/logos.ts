 ...
 */
import hPositive from "@/assets/logos/ICF_SwitzerlandCharterChapter_Horizontal_RGB_Positive.png.asset.json";
import hNegative from "@/assets/logos/ICF_SwitzerlandCharterChapter_Horizontal_RGB_Negative.png.asset.json";
import hWhite from "@/assets/logos/ICF_SwitzerlandCharterChapter_Horizontal_RGB_White.png.asset.json";
import vPositive from "@/assets/logos/ICF_SwitzerlandCharterChapter_Vertical_RGB_Positive.png.asset.json";
import vNegative from "@/assets/logos/ICF_SwitzerlandCharterChapter_Vertical_RGB_Negative.png.asset.json";
import vWhite from "@/assets/logos/ICF_SwitzerlandCharterChapter_Vertical_RGB_White.png.asset.json";
